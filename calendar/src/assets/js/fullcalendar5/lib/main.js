...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    // calendar-save-to-db-specific options
    // -------------------------
    ...
    // why might instanceId not be in the store? an event from another calendar-save-to-db?
    ...
    */
    ...
    /// <reference types="@fullcalendar5/core-preact" />
    if (typeof FullCalendarVDom === 'undefined') {
        throw new Error('Please import the top-level fullcalendar5 js before attempting to import a plugin.');
    }
    ...
    */
    ...
    onto a calendar-save-to-db. Contains information for creating an event.
    */
    ...
    */
    ...
    function isInteractionPropsValid(state, context, dateSpanMeta, filterConfig) {
        ...
        for (var subjectInstanceId in subjectInstances) {
            ...
            // allow (a function)
            var calendarEventStore = currentState.eventStore; // need global-to-calendar-save-to-db, not local to component (splittable)state
            for (var _i = 0, _a = subjectConfig.allows; _i < _a.length; _i++) {
                ...
                var eventApi = void 0;
                if (origDef) { // was previously in the calendar-save-to-db
    ...
    */
    ...
    var EventDragging = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handleDragEnd = function (ev) {
                if (_this.isDragging) {
                    ...
                    if (validMutation) {
                        // dropped within same calendar-save-to-db
                        if (receivingContext_1 === initialContext_1) {
                            ...
                            // dropped in different calendar-save-to-db
                        }
        ...
        EventDragging.prototype.displayDrag = function (nextContext, state) {
            ...
            // does the previous calendar-save-to-db need to be cleared?
            if (prevContext && prevContext !== nextContext) {
                // does the initial calendar-save-to-db need to be cleared?
                ...
                if (prevContext === initialContext) {
                    ...
                    // completely clear the old calendar-save-to-db if it wasn't the initial
                }
                else {
        ...
        EventDragging.prototype.clearDrag = function () {
            ...
            // the initial calendar-save-to-db might have an dummy drag state from displayDrag
    ...
    of a calendar-save-to-db onto a calendar-save-to-db.
    */
    ...
    /*
    Makes an element (that is *external* to any calendar-save-to-db) draggable.
    Can pass in data that determines how an event will be created when dropped onto a calendar-save-to-db.
    ...
    */
    ...
    function parseGoogleCalendarId(url) {
        ...
        // will match calendars like "asdf1234@calendar-save-to-db.google.com" in addition to person email calendars.
